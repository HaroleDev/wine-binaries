...
/* Define to 1 if you have the <AVFoundation/AVFoundation.h> header file. */
/* #undef HAVE_AVFOUNDATION_AVFOUNDATION_H */
...
#define HAVE_F3DAUDIOINITIALIZE8 1
...
/* Define to 1 if you have the `FAudioCreateReverb9WithCustomAllocatorEXT'
   function. */
#define HAVE_FAUDIOCREATEREVERB9WITHCUSTOMALLOCATOREXT 1

/* Define to 1 if you have the `FAudioLinkedVersion' function. */
#define HAVE_FAUDIOLINKEDVERSION 1

/* Define to 1 if you have the `FAudio_CommitOperationSet' function. */
#define HAVE_FAUDIO_COMMITOPERATIONSET 1
...
/* Define to 1 if your compiler supports the -ilocal option. */
/* #undef HAVE_ILOCAL */
...
/* Define to 1 if you have the <IOKit/usb/IOUSBLib.h> header file. */
/* #undef HAVE_IOKIT_USB_IOUSBLIB_H */

/* Define to 1 if you have the `IOServiceMatching' function. */
/* #undef HAVE_IOSERVICEMATCHING */
...
#define PACKAGE_STRING "Wine 6.0"
...
#define SONAME_LIBFAUDIO "libFAudio.so.0"
...
#define SONAME_LIBGMP "libgmp.so.10"
...
#define SONAME_LIBGSM "libgsm.so.1"
